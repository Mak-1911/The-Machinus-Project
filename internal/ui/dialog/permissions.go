...
func (p *Permissions) hasDiffView() bool {
	switch p.permission.Permission.ToolName {
...
func (p *Permissions) renderHeader(contentWidth int) string {
	...
	pathLine := p.renderKeyValue("Path", fsext.PrettyPath(p.permission.Permission.Path), contentWidth)
	...
	case tools.BashToolName:
		if params, ok := p.permission.Permission.Params.(tools.BashPermissionsParams); ok {
			lines = append(lines, p.renderKeyValue("Desc", params.Description, contentWidth))
		}
	case tools.DownloadToolName:
		if params, ok := p.permission.Permission.Params.(tools.DownloadPermissionsParams); ok {
	...
	case tools.EditToolName, tools.WriteToolName, tools.MultiEditToolName, tools.ViewToolName:
		var filePath string
		switch params := p.permission.Permission.Params.(type) {
	...
	case tools.LSToolName:
		if params, ok := p.permission.Permission.Params.(tools.LSPermissionsParams); ok {
...
func (p *Permissions) renderToolName(width int) string {
	toolName := p.permission.Permission.ToolName
...
func (p *Permissions) renderBashContent(width int) string {
	params, ok := p.permission.Permission.Params.(tools.BashPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderEditContent(contentWidth int) string {
	params, ok := p.permission.Permission.Params.(tools.EditPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderWriteContent(contentWidth int) string {
	params, ok := p.permission.Permission.Params.(tools.WritePermissionsParams)
	if !ok {
		return ""
	}
	return p.renderDiff(params.FilePath, params.OldContent, params.NewContent, contentWidth)
...
func (p *Permissions) renderMultiEditContent(contentWidth int) string {
	params, ok := p.permission.Permission.Params.(tools.MultiEditPermissionsParams)
	if !ok {
		return ""
	}
	return p.renderDiff(params.FilePath, params.OldContent, params.NewContent, contentWidth)
...
func (p *Permissions) renderDownloadContent(width int) string {
	params, ok := p.permission.Permission.Params.(tools.DownloadPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderFetchContent(width int) string {
	params, ok := p.permission.Permission.Params.(tools.FetchPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderAgenticFetchContent(width int) string {
	params, ok := p.permission.Permission.Params.(tools.AgenticFetchPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderViewContent(width int) string {
	params, ok := p.permission.Permission.Params.(tools.ViewPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderLSContent(width int) string {
	params, ok := p.permission.Permission.Params.(tools.LSPermissionsParams)
	if !ok {
		return ""
	}
...
func (p *Permissions) renderDefaultContent(width int) string {
	...
	if !strings.HasPrefix(p.permission.Permission.ToolName, "mcp_") {
		content = p.permission.Permission.Description
	}

	// Pretty-print JSON params if available.
	if p.permission.Permission.Params != nil {
		var paramStr string
		if str, ok := p.permission.Permission.Params.(string); ok {
			paramStr = str
		} else {
			paramStr = fmt.Sprintf("%v", p.permission.Permission.Params)
		}
